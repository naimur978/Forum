...
public class CreatePostFragment extends Fragment {
        ...
        private FragmentActivity createFragment;
       ...
       /* actionBar = getActionBar();
        ...
        actionBar.setDisplayHomeAsUpEnabled(true);*/
            ...
            titleEt = root.findViewById(R.id.pTitleEt);
            descriptionEt = root.findViewById(R.id.pDescriptionEt);
            imageIv = root.findViewById(R.id.pImageIv);
            uploadBtn= root.findViewById(R.id.pUploadBtn);

            //get data through intent from previous activitie's adapter, then change it
            createFragment = getActivity();
            Intent intent= createFragment.getIntent();
            ...
            pd = new ProgressDialog(root.getContext(), R.style.AppCompatAlertDialogStyle);
            ...
            uploadBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(TextUtils.isEmpty(title)){
                        Toast.makeText(createFragment, "Enter title...", Toast.LENGTH_SHORT).show();
                        return;
                    }

                    if(TextUtils.isEmpty(description)){
                        Toast.makeText(createFragment, "Enter description...", Toast.LENGTH_SHORT).show();
                        return;
                    }
                                                ...
                                                ref.child(editPostId)
                                                        ...
                                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                            ...
                                                            public void onSuccess(Void aVoid) {
                                                                ...
                                                                Toast.makeText(createFragment, "Updated...", Toast.LENGTH_SHORT).show();
        ...
        private void loadPostData(String editPostId) {
            ...
            fquery.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    //in case of error
                    Toast.makeText(createFragment, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
                                    ...
                                    ref.child(timeStamp).setValue(hashMap)
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void aVoid) {
                                                    //added in database
                                                    pd.dismiss();
                                                    Toast.makeText(createFragment, "Post Published", Toast.LENGTH_SHORT).show();
        ...
        private void sendPostNotification(JSONObject notificationJo) {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fom.googleapis.com/fcm/send", notificationJo,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(createFragment, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
            {
                @Override
            ...
            Volley.newRequestQueue(createFragment).add(jsonObjectRequest);
        }
        ...
        private void showImagePickDialog() {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(createFragment);
        ...
        private void pickFromCamera() {
            ...
            //put image uri
            image_pUri = createFragment.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,values);
       ...
       /* Intent galleryIntent = new Intent(Intent.ACTION_PICK);
        ...
        private boolean checkStoragePermission(){
            boolean result = ContextCompat.checkSelfPermission(createFragment,
        ...
        private void requestStoragePermission(){
            ActivityCompat.requestPermissions(createFragment,storagePermissions,STORAGE_REQUEST_CODE);
        ...
        private boolean checkCameraPermission(){
            boolean result = ContextCompat.checkSelfPermission(createFragment,
                    ...
                    == (PackageManager.PERMISSION_GRANTED);
            boolean result1 = ContextCompat.checkSelfPermission(createFragment,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    == (PackageManager.PERMISSION_GRANTED);
        ...
        private void requestCameraPermission(){
            ActivityCompat.requestPermissions(createFragment,cameraPermissions,CAMERA_REQUEST_CODE);
        }
        //................................................................................permissions
        ...
        private void checkUserStatus(){
            ...
            if(user != null){
                ...
                startActivity(new Intent(createFragment,SettingsActivity.class));
                createFragment.finish();
            }
        }

//        @Override
//        public boolean onSupportNavigateUp() {
//            createFragment.onBackPressed();//goto previous activity
                ...
                case CAMERA_REQUEST_CODE:{
                    if(grantResults.length>0){
                        ...
                        if(cameraAccepted && storageAccepted){
                            ...
                            Toast.makeText(createFragment, "Please enable Camera & Storage Permission", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                break;
                ...
                case STORAGE_REQUEST_CODE:{
                    if(grantResults.length>0){
                        ...
                        if( storageAccepted){
                            ...
                            Toast.makeText(createFragment, "Please enable Storage Permission", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                break;
