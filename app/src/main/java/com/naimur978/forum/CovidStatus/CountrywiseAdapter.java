...
public class CountrywiseAdapter extends RecyclerView.Adapter<com.naimur978.forum.CovidStatus.CountrywiseAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<com.naimur978.forum.CovidStatus.CountrywiseModel> arrayList;
    private com.naimur978.forum.CovidStatus.CountrywiseAdapter.OnItemClickListner mListner;
    ...
    public CountrywiseAdapter(Context context, ArrayList<com.naimur978.forum.CovidStatus.CountrywiseModel> countrywiseModelArrayList) {
        mContext = context;
    ...
    @NonNull
    @Override
    public com.naimur978.forum.CovidStatus.CountrywiseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull com.naimur978.forum.CovidStatus.CountrywiseAdapter.ViewHolder holder, final int position) {
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                com.naimur978.forum.CovidStatus.CountrywiseModel clickedItem = arrayList.get(position);
        ...
        com.naimur978.forum.CovidStatus.CountrywiseModel currentItem = arrayList.get(position);
    ...
    public void filterList(ArrayList<com.naimur978.forum.CovidStatus.CountrywiseModel> filteredList) {
