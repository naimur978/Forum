package com.naimur978.forum.CovidStatus;
...
public class CountrywiseDataActivity extends AppCompatActivity {
    ...
    private com.naimur978.forum.CovidStatus.CountrywiseAdapter countrywiseAdapter;
    private RequestQueue requestQueue;
    private ArrayList<com.naimur978.forum.CovidStatus.CountrywiseModel> countrywiseModelArrayList;
...
//      getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(com.naimur978.forum.CovidStatus.CountrywiseDataActivity.this, "Data refreshed!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void filter(String text) {
        ArrayList<com.naimur978.forum.CovidStatus.CountrywiseModel> filteredList = new ArrayList<>();
        for (com.naimur978.forum.CovidStatus.CountrywiseModel item : countrywiseModelArrayList) {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        countrywiseModelArrayList.add(new com.naimur978.forum.CovidStatus.CountrywiseModel(countryName, countryConfirmed, countryActive, countryDeceased, countryNewConfirmed, countryNewDeceased, countryRecovered, countryTests, flagUrl, countryNewRecovered));


                        Collections.sort(countrywiseModelArrayList, new Comparator<com.naimur978.forum.CovidStatus.CountrywiseModel>() {
                            @Override
                            public int compare(com.naimur978.forum.CovidStatus.CountrywiseModel o1, com.naimur978.forum.CovidStatus.CountrywiseModel o2) {
                    ...
                    if (!testValue.isEmpty()) {
                        Runnable progressRunnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                countrywiseAdapter = new com.naimur978.forum.CovidStatus.CountrywiseAdapter(com.naimur978.forum.CovidStatus.CountrywiseDataActivity.this, countrywiseModelArrayList);
    ...
    public void onItemClick(int position) {
        Intent perCountryIntent = new Intent(this, com.naimur978.forum.CovidStatus.PerCountryData.class);
        com.naimur978.forum.CovidStatus.CountrywiseModel clickedItem = countrywiseModelArrayList.get(position);
    ...
    public void showProgressDialog() {
        progressDialog = new ProgressDialog(com.naimur978.forum.CovidStatus.CountrywiseDataActivity.this);
        progressDialog.show();
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (confirmation != 1) {
                    progressDialog.cancel();
                    Toast.makeText(com.naimur978.forum.CovidStatus.CountrywiseDataActivity.this, "Internet slow/not available", Toast.LENGTH_SHORT).show();
                }
            }
        };
        Handler pdCanceller = new Handler();
