...
public class WorldDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(com.naimur978.forum.CovidStatus.WorldDataActivity.this, "Data refreshed!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void showProgressDialog() {
        progressDialog = new ProgressDialog(com.naimur978.forum.CovidStatus.WorldDataActivity.this);
        progressDialog.show();
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (confirmation != 1) {
                    progressDialog.cancel();
                    Toast.makeText(com.naimur978.forum.CovidStatus.WorldDataActivity.this, "Internet slow/not available", Toast.LENGTH_SHORT).show();
                }
            }
        };
